...
<link rel="stylesheet" type="text/css" href="https://www.mcdonalds.co.kr/kor/css/common.css?t=2022012502">
...
<!-- End Google Tag Manager (noscript) -->
   ...
   <div class="wrapper ">
      <jsp:include page="/kor/layout/header.jsp"></jsp:include> 
...
<div class="content">
   ...
   <c:if test="${ not empty list }">
    ...
    <c:if test="${dto.N_NOTI  eq 1}"><!-- 공지  -->
		  	<li class="notice">
						<a href="javascript:goDetail(519,1)"><!--   이것도 넣는건가 ..? -->
							<span class="bNum">
								<b class="ico">공지</b>
							</span>
							<span class="bSubject"><strong class="tit">${dto.N_TITLE }</strong></span>
							<span class="bDate">${dto.N_DATE}</span>
						</a>
					</li>
		  </c:if>
		  <c:if test="${dto.N_NOTI  eq 0}"><!-- 공지  -->
		 <li class="notice">
						<a href="javascript:goDetail(572)">
							<span class="bNum">
								<span class="hide">게시물 번호</span>${st.count }
							</span>
							<span class="bSubject"><strong class="tit">${dto.N_TITLE }</strong></span>
							<span class="bDate">${dto.N_DATE}</span>
						</a>
...
function goDetail(seq,rnum){
   ...
   $("#searchForm").submit();
      ...
      <!-- //container -->
      <jsp:include page="/kor/layout/footer.jsp"></jsp:include> 
      <!-- //footer -->
   </div>
   <!-- //wrapper -->
   ...
   <div class="popLayer layerS layerType03" id="crew_1">
      <div class="layCont">
         <div class="scroll crewDetail">
            <div class="contHead">
               <div class="img"><img src="<%= contextPath %>/kor/images/story/img_crew_pop01.jpg" alt="목포 남악 DT점 김지웅 매니저"></div>
            </div>
   ...
   <div class="popLayer layerS layerType03" id="crew_2">
      <div class="layCont">
         <div class="scroll crewDetail">
            <div class="contHead">
               <div class="img"><img src="<%= contextPath %>/kor/images/story/img_crew_pop02.jpg" alt="경희대점 권영미 크루"></div>
            </div>
            <div class="contBtm crewCont">
   ...
   <div class="popLayer layerS layerType03" id="crew_3">
      <div class="layCont">
         <div class="scroll crewDetail">
            <div class="contHead">
               <div class="img"><img src="<%= contextPath %>/kor/images/story/img_crew_pop03.jpg" alt="미아역점 이지혁 라이더"></div>
            </div>
            <div class="contBtm crewCont">
   ...
   <div class="popLayer layerS layerType03" id="crew_4">
      <div class="layCont">
         <div class="scroll crewDetail">
            <div class="contHead">
               <div class="img"><img src="<%= contextPath %>/kor/images/story/img_crew_pop04.jpg" alt="석촌역점 이나라 크루"></div>
            </div>
            <div class="contBtm crewCont">
