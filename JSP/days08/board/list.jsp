...
<title>2022. 6. 20.-오후 12:43:38</title>
...
<script>
   //list.htm?write=sucess
   if('<%=request.getParameter("write") %>'=='success'){
      alert("글 쓰기 완료!!!")
   }
   
   //list.htm?delete=sucess
...
$("#searhword").val('${param.searchWord}');
// /list.htm?currentpage=2&searchCondigion=3&seachWord=검색
$(".pagination a:not(.active)").attr("href", function ( i, val ){
   return val + "&searchCondigion=${ param.searchCondition}&searchWord=${ param.searchWord }"; 
});   
</script>
</body>
</html>